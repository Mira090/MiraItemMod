...
namespace MiraItemMod
{
        ...
        public static Dictionary<string, string> commandDescriptionsJapanese = new Dictionary<string, string>
    {
        ...
        { "UNLOCKPOCKETDIMENSIONSHOPITEM", "ディメンションショップアイテムすべて解放" },
        ...
        { "UNLOCKTREESHOPITEMALL", "すべてのツリーショップアイテムを解放 (NewCharm_Bossを除く)" },
        { "LOCKTREESHOPITEM", "ツリーショップアイテムをロック (パラメータ: ツリーショップアイテムID)" },
