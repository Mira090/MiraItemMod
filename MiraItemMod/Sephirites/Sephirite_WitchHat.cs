...
{
    public class Sephirite_WitchHat : Sephirite_Custom
    {
        ...
        {
            return player.unlockedCharms.Where(x => ItemDatabase.FindItemById(x)?.activeType == EItemActiveType.WitchHat).ToList();
        }
